export const ERROR_CODES = {
  ...
  AUTH_TOO_MANY_SIGNUPS: 'AUTH_TOO_MANY_SIGNUPS',
...
export const MESSAGES = {
  AUTH: {
    ...
    TOKEN_REVOKED: 'This session has been signed out. Please login again.',
    ...
    TOO_MANY_ATTEMPTS: 'Too many failed sign-in attempts. Please try again in 15 minutes.',
    TOO_MANY_SIGNUPS: 'Too many accounts created from this network. Please try again later.',
  },
  RECIPE: {
